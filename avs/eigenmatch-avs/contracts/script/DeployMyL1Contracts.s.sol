...
contract DeployMyL1Contracts is Script {
    ...
    function run(string memory environment, string memory _context) public {
        ...
        EigenMatchDigestRegistry registry = new EigenMatchDigestRegistry(context.avs);
        console.log("EigenMatchDigestRegistry deployed to:", address(registry));
        ...
        outputs[0] = Output({name: "EigenMatchDigestRegistry", contractAddress: address(registry)});
